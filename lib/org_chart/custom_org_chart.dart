...
import 'package:customized_org_chart/org_chart/custom_animated_positioned.dart';
import 'package:customized_org_chart/org_chart/edge_painter.dart';
...
class CustomOrgChart<E> extends StatefulWidget {
  ...
  /// options builder to build the menu that appears when you long press or right click on a node
  /// can be customized per item
  final List<PopupMenuEntry<dynamic>> Function(E node)? optionsBuilder;

  final Map<OrgNode<E>, LineStyle> uniqueLineStyles;
  ...
  @override
  State<CustomOrgChart<E>> createState() => _CustomOrgChartState();
}

class _CustomOrgChartState<E> extends State<CustomOrgChart<E>> {
          ...
          children: [
            CustomPaint(
              ...
              painter: EdgePainter<E>(
                ...
                lineStyles: widget.uniqueLineStyles,
              ),
            ),
  ...
  bool isSubNode(OrgNode<E> dragged, OrgNode<E> target) {
    E? to = target.data;
